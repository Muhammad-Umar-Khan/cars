$(document).ready(function(){
    $('#calcclickfalse').click(function(){
        changeCalcYears(false)
    })
    $('#calcclicktrue').click(function(){
        changeCalcYears(true)
    })
    $('#calcamountfalse').click(function(){
        alterCalcAmount(false);
    })
    $('#calcamounttrue').click(function(){
        alterCalcAmount(true);
    })
})
            ...
            $.ajax({
                ...
                success: function(a) {
                    ...
                    t += a.length, $(".faq-results-found__count").removeClass("hidden"), $(".faq-search-results").removeClass("hidden"), a.length >= 1 ? (a.length <= 5 ? ($(".faq-view-more").addClass("hidden"), $("#reveal-more-results-btn").addClass("hidden")) : ($(".faq-view-more").removeClass("hidden"), $("#reveal-more-results-btn").removeClass("hidden"), $(".rev-more").removeClass("hidden")), $(".faq-result-found").removeClass("hidden"), $(".faq-not-found").addClass("hidden"), $(".childquestions").removeClass("hidden"), $(".faq-results-list").removeClass("hidden"), $(".numberOfResults").text(t), $(".searchTerm").text(e), $.each(a, function(e, t) {
                        ...
                        var s = $("<li></li>").append($("<a></a>").attr("href", t.linkText).append($('<div className="questionSearched"></div>').html(r)).append($('<div className="answerSearched"></div>').html(a)));
                        n.push(s)
                    }), $('ul[className="faq-results-list"]').append.apply($('ul[className="faq-results-list"]'), n).hide().fadeIn(500), $("html, body").animate({
                        scrollTop: $(".faq-results-found__count").offset().top
                    }, 750), $(".childquestions").html(), $(".faq-results-list").empty(), $(".faq-results-list").append.apply($(".faq-results-list"), n), highlight(r)) : 1 > t && ($(".faq-not-found").removeClass("hidden"), $(".faq-results-found__count").addClass("hidden"), $(".childquestions").addClass("hidden"), $('ul[className="faq-results-list"]').addClass("hidden"), $(".rev-more").addClass("hidden"))
                }
            })
        }
...
$(document).ready(function() {
    ...
    var e = 'View more results <i className="fa fa-plus" aria-hidden="true"></i>',
        t = 'View less results <i className="fa fa-minus" aria-hidden="true"></i>';
